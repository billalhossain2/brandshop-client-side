  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      ...
      <h3 className='text-3xl font-bold text-center'>Login</h3>
        ...
        <button className="hover:bg-[#F5921D] px-5 py-2 rounded-lg font-bold hover:text-white border-[1px] border-solid border-[#F5921D] text-[#F5921D]">Login</button>
        <p className="font-bold text-center">Or</p>
          <button className="hover:bg-[#F5921D] px-5 py-2 rounded-lg font-bold hover:text-white border-[1px] border-solid border-[#F5921D] text-[#F5921D]">Login with Google</button>
        </div>
